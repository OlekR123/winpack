  ...
  <div>
    ...
    <section class="warning-section">
      <div class="warning-middle">
        <img class="warning-decor-left" :src="img.warningDotsLeft" alt="" aria-hidden="true" />
        <div class="warning-center">
          <p class="warning-title">Будьте внимательны при выборе параметров настройки Windows.</p>
          <p class="warning-text">Изменение некоторых из них может повлиять на работу системы. Если вы не уверены, что делает настройка — лучше не включайте её.</p>
          <p class="warning-footer">Администрация сайта не несёт ответственность за ваш выбор.</p>
        </div>
        <img class="warning-decor-right" :src="img.warningDotsRight" alt="" aria-hidden="true" />
      </div>
    </section>
...
async function downloadConfig() {
  ...
  try {
    ...
    downloadBlob(blob, 'WinPackConfig.ps1');
...
.section-title { font-size: 2.0833vw; line-height: 1.1; color: #1f2937; }

.hero { background: #1f2937; color: #fff; border-bottom-left-radius: 1.25vw; border-bottom-right-radius: 1.25vw; padding-bottom: 3.125vw; position: relative; }
...
.section-arrow:hover:not(.disabled) {
  ...
  box-shadow: 0 .4167vw .8333vw rgba(0,0,0,.12);
}
...
.program-btn {
  ...
  border-radius: 0.4vw;
  text-decoration: none;
  font-weight: 500; font-size: 1.25vw;
...
.warning-section { border-radius: 1.25vw; padding: 3.125vw 0; background: #f7f7f7; }

.warning-middle { display: flex; align-items: center; justify-content: space-between; margin: 0 17.4479vw; position: relative; }
.warning-center {
  flex: 1;
  text-align: center;
  padding: 3.125vw 0;
}
.warning-decor-left, .warning-decor-right { height: 2.6042vw; pointer-events: none; }
.warning-decor-left { align-self: flex-end; }
.warning-decor-right { align-self: flex-start; }
.warning-title { color: #1f2937; font-size: 1.25vw; line-height: 1.4; margin: 0 0 1.0417vw 0; font-weight: 400; }
.warning-text { color: #1f2937; font-size: 1.0417vw; line-height: 1.5; margin: 0 0 1.0417vw 0; font-weight: 300; }
.warning-footer {
  color: #1f2937;
  font-size: 1.0417vw;
  line-height: 1.4;
...
.setting-checkbox-label {
  ...
  background: #fff;
  border: 0.1042vw solid #d1d5db;
  border-radius: 0.2083vw;
  display: block;
  transition: all 0.15s ease;
}
.setting-checkbox-input:checked + .setting-checkbox-label { background: #facc15; border-color: #facc15; }
.setting-checkbox-input:checked + .setting-checkbox-label::after {
  content: '';
  position: absolute; left: 0.4vw;
  top: 0.15vw; width: 0.4vw;
  height: 0.7vw;
  border: solid #1f2937;
...
.logout-confirm-text {
  color: #1f2937; font-size: 1.25vw;
  font-family: inherit;
  font-weight: 400;
  margin: 0 0 1vw 0; text-align: center;
  line-height: 1.4;
}
...
.program-checkbox-input:checked + .program-checkbox-label::after {
...
@media (max-width: 1200px) {
  ...
  .warning-section { border-radius: 20px; padding: 40px 0; }
  .warning-middle { margin: 0 60px; }
  .warning-center { padding: 40px 0; }
  .warning-decor-left, .warning-decor-right { height: 32px; }
  .warning-title { font-size: 20px; margin-bottom: 16px; }
  .warning-text { font-size: 16px; margin-bottom: 16px; }
  .warning-footer { font-size: 16px; }
  .settings-block {
    border-radius: 12px;
    padding: 40px;
    margin-top: 40px;
...
@media (max-width: 768px) {
  ...
  .warning-section { border-radius: 0; padding: 32px 0; }
  .warning-middle { margin: 0 24px; }
  .warning-center { padding: 32px 0; }
  .warning-decor-left { width: 80px; height: auto; align-self: flex-end; }
  .warning-decor-right { width: 70px; height: auto; align-self: flex-start; }
  .warning-title {
    font-size: 16px;
    margin-bottom: 12px;
    line-height: 1.4;
  }
  .warning-text { font-size: 14px; margin-bottom: 12px; line-height: 1.6; }
  .warning-footer { font-size: 14px; }
  .settings-block {
    border-radius: 8px;
    padding: 24px;
    margin-top: 32px;
